...
// OzaRender.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(COzaRenderApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &COzaRenderApp::OnAppAbout)
...
COzaRenderApp::COzaRenderApp() noexcept : currentRenderPackage(COzaRenderApp::RenderPackage::Vulkan)
{
	...
	SetAppID(_T("OzaRender.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only COzaRenderApp object

COzaRenderApp theApp;


// COzaRenderApp initialization

BOOL COzaRenderApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(COzaRenderDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(COzaRenderView));
	if (!pDocTemplate)
		return FALSE;
...
int COzaRenderApp::ExitInstance()
{
...
void COzaRenderApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// COzaRenderApp customization load/save methods

void COzaRenderApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void COzaRenderApp::LoadCustomState()
{
}

void COzaRenderApp::SaveCustomState()
{
}
