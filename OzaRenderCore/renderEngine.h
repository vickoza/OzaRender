...
public:
	...
	virtual void ApplyTransforms(const std::array<double, 4>& eulerRot, const std::array<double, 4>& translation, const std::array<double, 4>& scale) = 0;
	...
	virtual void ApplyMaterial(const std::array<float, 4>& ambient, const bool& ambientSet, const std::array<float, 4>& diffuse, const bool& diffuseSet, const std::array<float, 4>& specular, const bool& specularSet, const float& shininess, const bool& shininessSet) = 0;
